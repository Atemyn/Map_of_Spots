...
public class CreateReadDeleteImageSlider extends RecyclerView.Adapter<CreateReadDeleteImageSlider.SliderViewHolder>{
    ...
    public CreateReadDeleteImageSlider(FragmentActivity activity,
    ...
    public void onBindViewHolder(@NonNull SliderViewHolder holder, int position) {
        if (imagesUrls.get(position).isFromServer()) {
            OkHttpClient client = new OkHttpClient();

            Request request = new Request.Builder()
                    .url("http://" + imagesUrls.get(position).getImageUrl())
                    .build();
            ...
            Glide.with(holder.itemView.getContext())
                    .load(imagesUrls.get(position).getImageUrl())
